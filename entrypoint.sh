...
UUID=${UUID:-'f5a6d24a-ee93-4d4d-bab4-76e0f230ff43'}
VMESS_WSPATH=${VMESS_WSPATH:-'/f5a6d24a-ee93-4d4d-bab4-76e0f230ff43-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/f5a6d24a-ee93-4d4d-bab4-76e0f230ff43-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/f5a6d24a-ee93-4d4d-bab4-76e0f230ff43-trojan'}
SS_WSPATH=${SS_WSPATH:-'/f5a6d24a-ee93-4d4d-bab4-76e0f230ff43-shadowsocks'}
